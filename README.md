...
![](https://github.com/WebTastic/action-slack/workflows/build-test/badge.svg)
![](https://github.com/WebTastic/action-slack/workflows/Slack%20Mainline/badge.svg)
![](https://img.shields.io/github/license/WebTastic/action-slack?color=brightgreen)
![](https://img.shields.io/github/v/release/WebTastic/action-slack?color=brightgreen)
[![codecov](https://codecov.io/gh/WebTastic/action-slack/branch/main/graph/badge.svg)](https://codecov.io/gh/WebTastic/action-slack)
...
See here for `payload` reference or [Custom Notification](https://github.com/WebTastic/action-slack#custom-notification).
...
```yaml
- uses: WebTastic/action-slack@v3
  with:
    status: ${{ job.status }}
